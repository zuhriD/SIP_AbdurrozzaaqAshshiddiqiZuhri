				...
				<div class="card">
					...
					<div class="card-body">
						<div class="mx-auto d-block">
							@if ($user != null)
							<a href="{{asset('images/'.$user->foto_profil)}}" download><img class="rounded-circle mx-auto d-block" style="max-width: 60%;" src="{{asset('images/'.$user->foto_profil)}}" alt="Card image cap"></a>
